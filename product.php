											...
											<div class="description" itemprop="description">
												<?=$row["description"]?>
													...
													<div class="purchase-section multiple">
														...
														<div class="purchase">
															<button id="add-to-cart" class="btn add-to-cart" name="add"><a class="wish-list" href="add_cart.php?id=<?=$row['id']?>"><span class="hidden-xs"><i class="fa fa-shopping-bag"></i>Mua ngay</button>
														</div>
													</div>
												</div>
												 ...
												 ?>
													<div class="content_product">
														<div class="row-container product list-unstyled clearfix">
															<div class="row-left">
																<a href="./index_product.php?id=<?=$row1['id']?>" class="hoverBorder container_item">
