											...
											<form action="./cart.php" method="post" id="cartform">
												...
												<table class="cart-items">
													...
													<tr>
														...
														<td style="max-width: 190px;"><input type="text" name="name" value="<?= $_SESSION['phone_number']?>" readonly="readonly"></td>
														<td style="max-width: 190px;"><input type="text" name="name" value="<?= $_SESSION['address']?>" readonly="readonly"></td>
														<td style="max-width: 190px;"><input type="text" name="date_order" value="<?= $currentDate ?>" readonly="readonly"></td>
														<td style="max-width: 190px;"><input type="text" name="payment" value="COD" readonly="readonly"></td>
